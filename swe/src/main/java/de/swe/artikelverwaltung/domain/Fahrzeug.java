...
@NamedQueries({
	...
	@NamedQuery(name = Fahrzeug.FIND_FAHRZEUG_ORDER_BY_ID,
		query = "FROM Fahrzeug f order by f.fId"),
	@NamedQuery(name = Fahrzeug.FIND_FAHRZEUG_BY_ID,
		query = "FROM Fahrzeug f WHERE f.fId = :" + Fahrzeug.PARAM_FAHRZEUG_ID),
	@NamedQuery(name = Fahrzeug.FIND_FAHRZEUG_BY_HERSTELLER,
		query =  "FROM Fahrzeug f WHERE f.hersteller.aId = :" + Fahrzeug.PARAM_FAHRZEUG_HERSTELLER),
